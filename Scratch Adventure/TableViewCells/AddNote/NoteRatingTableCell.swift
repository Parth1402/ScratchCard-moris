//
//  HorizontalCalenderTableCell 2.swift
//  Scratch Adventure
//
...
class NoteRatingTableCell: UITableViewCell {
    ...
    private func setupTableView() {
        ...
        NSLayoutConstraint.activate([
            tableView.topAnchor.constraint(equalTo: ContentContainer.topAnchor, constant: 8),
...
extension NoteRatingTableCell:  UITableViewDataSource, UITableViewDelegate, RatingTableCellDelegate {
