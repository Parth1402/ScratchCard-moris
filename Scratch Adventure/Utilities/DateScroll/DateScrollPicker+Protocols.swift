...
import UIKit
 ...
 protocol DateScrollPickerDataSource: class {
    ...
    func dateScrollPicker(_ dateScrollPicker: DateScrollPicker, dotColorByDate date: Date) -> UIColor?
      ...
      */
     func dateScrollPicker(_ dateScrollPicker: DateScrollPicker, borderColorByDate date: Date) -> UIColor?
}

extension DateScrollPickerDataSource {
